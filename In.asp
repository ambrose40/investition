...
<a href="in.asp?&sr=<%=srt & dd%>&no=<%=n%>&y=<%=zzz%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=Request.QueryString("so")%>"><Img border="0" src="icons/p.ico" Style=float:left></a><a href="in.asp?sr=<%=srt & dd%>&no=<%=n%>&y=<%=zzz2%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=Request.QueryString("so")%>"><Img border="0" src="icons/n.ico" Style=float:right></a>
...
<th class="inv">
<a href="in.asp?so=<%=Request.QueryString("so")%>&y=<%=zo%>"class="th">*</a>
</th>
...
<%If srt="" then%>
 ...
 <a href="in.asp?sr=<%="ProjCode,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>" class="th">Proekti kood ja nimetus</a>
...
<%Else%>
 ...
 <%Loop%>
 <%If f=1 Then%>
  <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Proektide kood ja nimetus <img border="0" src="icons/down.png"></a>
 <%Else%>
  <%If f=4 Then%>
   <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Proektide kood ja nimetus <img border="0" src="icons/up.png"></a>
  <%Else%> 
   <a href="in.asp?sr=<%=bz & "ProjCode,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Proektide kood ja nimetus </a>
  <%End If%>
 <%End If%>
<%End If%>
</th> 
</form>
<Form Method="PUT" ID="forma" class="inv Action="in.asp?sr=<%=srt & dd%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>#<%="vira" & i8 & i9%>">
...
<%If srt="" then%>
 <th class="inv">
 <a href="in.asp?sr=<%="Enterprise,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Ettev&otilde;te </a>
...
<%Else%>
 ...
 <%If f=1 Then%>
  <th class="inv">
  <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Ettev&otilde;te <img border="0" src="icons/down.png"></a>
<select size="1" name="entt" class="Inv" onChange="subme()">
<%mdbore.Movefirst%>
<%If np="" Then%>
<option value="All" selected="True">K&otilde;ik</option>
...
<%Loop%>
 ...
 <%Else%>
  <%If f=4 Then%>
   <th class="inv">
   <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Ettev&otilde;te <img border="0" src="icons/up.png"></a>
<select size="1" name="entt" class="inv" onChange="subme()">
<%mdbore.Movefirst%>
<%If np="" Then%>
<option value="All" selected="True">K&otilde;ik</option>
...
<%Loop%>
  ...
  <%Else%> 
  <th class="inv">
  <a href="in.asp?sr=<%=bz & "Enterprise,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Ettev&otilde;te</a>
<select size="1" name="entt" class="inv" onChange="subme()">
<%mdbore.Movefirst%>
<%If np="" Then%>
<option value="All" selected="True">K&otilde;ik</option>
...
<%If srt="" then%>
 <th class="inv">
 <a href="in.asp?sr=<%="SummYe,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Planeeritud summa</a>
 </th>
 <th class="inv">
 <a href="in.asp?sr=<%="SummYe,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Lepingup&otilde;hine summa </a>
 </th>
<%Else%>
 <%l=Len(srt)%>
 <%bz=""%>
 ...
 <%If f=1 Then%>
  <th class="inv">
  <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Planeeritud summa <img border="0" src="icons/down.png"></a>
  </th> 
  <th class="inv">
  <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Lepingup&otilde;hine summa <img border="0" src="icons/down.png"></a>
  </th> 
 <%Else%>
  <%If f=4 Then%>
   <th class="inv">
   <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Planeeritud summa <img border="0" src="icons/up.png"></a>
   </th>  
   <th class="inv">
   <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Lepingup&otilde;hine summa <img border="0" src="icons/up.png"></a>
   </th>  
  <%Else%> 
  <th class="inv">
  <a href="in.asp?sr=<%=bz & "SummYe,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Planeeritud summa</a>
  </th>
  <th class="inv">
  <a href="in.asp?sr=<%=bz & "SummYe,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Lepingup&otilde;hine summa </a>
  </th>
  <%End If%>
 <%End If%>
<%End If%>
...
<%If srt="" then%>
 <th class="inv">
 <a href="in.asp?sr=<%="StatusId,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Seisund</a>
 </th>
<%Else%>
 <%l=Len(srt)%>
 <%bz=""%>
 ...
 <%If f=1 Then%>
  <th class="inv">
  <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Seisund <img border="0" src="icons/down.png"></a>
  </th> 
 <%Else%>
  <%If f=4 Then%>
   <th class="inv">
   <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Seisund <img border="0" src="icons/up.png"></a>
   </th>  
  <%Else%> 
  <th class="inv">
  <a href="in.asp?sr=<%=bz & "StatusId,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Seisund</a>
  </th>
  <%End If%>
 <%End If%>
<%End If%>
...
<%If srt="" then%>
 <th class="inv">
 <a href="in.asp?sr=<%="EmployeeId,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Vastutav t&ouml&oumltaja</a>
...
<%Else%>
 ...
 <%If f=1 Then%>
  <th class="inv">
  <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Vastutav t&ouml&oumltaja <img border="0" src="icons/down.png"></a>
<select size="1" name="wrkk" class="inv" onChange="subme()">
<%mdborw.Movefirst%>
<%If pb="" Then%>
<option value="All" selected="True">K&otilde;ik</option>
...
<%Loop%>
 ...
 <%Else%>
  <%If f=4 Then%>
   <th class="inv">
   <a href="in.asp?sr=<%=bz%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Vastutav t&ouml&oumltaja <img border="0" src="icons/up.png"></a>
<select size="1" name="wrkk" class="inv" onChange="subme()">
<%mdborw.Movefirst%>
<%If pb="" Then%>
<option value="All" selected="True">K&otilde;ik</option>
...
<%Loop%>
  ...
  <%Else%> 
  <th class="inv">
  <a href="in.asp?sr=<%=bz & "EmployeeId,"%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>"class="th">Vastutav t&ouml&oumltaja</a>
<select size="1" name="wrkk" class="inv" onChange="subme()">
<%mdborw.Movefirst%>
<%If pb="" Then%>
<option value="All" selected="True">K&otilde;ik</option>
...
<img border="0" src="icons/invpla.ico" Style=float:Left><p align="Center"><a href="Main.asp" class="headlink"><b>inEERIMISKAVA <%=LEFT(RIGHT(ia,5),4)%> m.a.</b></a></p><p>
...
<td class="inv" class="inv">
<a href="in.asp?sr=<%=srt & dd%>&e3=<%="Enterprise='" & mdbor4("Enterprise") & "'"%>&no=<%="3"%>&so=<%=so%>&s=<%=co%>&em=<%=pb%>&y=<%=zo%>"><%=mdbor4("Edescr")%></a>
</td>
<td class="inv" class="inv">
<%=mdbor4P("SummYe")%>
...
<%End If%>
<a href="in.asp?sr=<%=srt & dd%>&s=<%="StatusID='" & mdbor4("StatusID") & "'"%>&no=<%="3"%>&so=<%=so%>&y=<%=zo%>&em=<%=pb%>&e3=<%=np%>"><%=mdbor4("StatusName")%></a>
</td>
<td class="inv" class="inv">

<%a33="?" & mdbor4("EmployeeID")%>
<%If a33 = "?" Then%>
<a href="in.asp?sr=<%=srt & dd%>&em=<%="EmployeeID IS NULL "%>&so=<%=Request.QueryString("So")%>&no=<%="3"%>&y=<%=zo%>&s=<%=co%>&e3=<%=np%>"><%=mdbor4("EmplFName")%>&nbsp<%=mdbor4("EmplName")%></a>
<%Else%>
<a href="in.asp?sr=<%=srt & dd%>&em=<%="EmployeeID='" & mdbor4("EmployeeID") & "'"%>&so=<%=Request.QueryString("So")%>&no=<%="3"%>&y=<%=zo%>&s=<%=co%>&e3=<%=np%>"><%=mdbor4("EmplFName")%>&nbsp<%=mdbor4("EmplName")%></a>
<%End If%>
</td>
</tr>
...
<%mdbor4P.Close%>
<%Else%>
<%="SELECT DISTINCT ProjCode,ProjName,Yearr from inpl1 WHERE Identifier='C' AND " & ia & " AND ProjCode LIKE '__.00.00' AND ((DateBegin<='" & d & "' AND DateEnd>='" & d & "') OR StatusID IS NULL OR StatusID='6' OR StatusID='7')"%>
<%mdbo2.CommandText="SELECT DISTINCT ProjCode,ProjName,Yearr from inpl1 WHERE Identifier='C' AND " & ia & " AND ProjCode LIKE '__.00.00' AND ((DateBegin<='" & d & "' AND DateEnd>='" & d & "') OR StatusID IS NULL OR StatusID='6' OR StatusID='7')"%>
<%mdbor.Open mdbo2%>
...
<Form Method="POST" Action="in.asp?sr=<%=srt & dd%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>#<%="vira" & i8 & i9%>">
<%i9=1%>
<%Do Until mdbor.EOF%>
<trBBDDFF>
<td class="inv" class="inv">
...
<%="SELECT DISTINCT ProjCode,ProjName,Yearr from inpl1 WHERE "& ia & " AND Identifier='C' AND ProjCode LIKE '" & p8 & ".__.00' AND ProjCode <> '" & p7 & "' AND ((DateBegin<='" & d & "' AND DateEnd>='" & d & "') OR StatusID IS NULL OR StatusID='6' OR StatusID='7')"%>
<%mdbo3.CommandText="SELECT DISTINCT ProjCode,ProjName,Yearr from inpl1 WHERE "& ia & " AND Identifier='C' AND ProjCode LIKE '" & p8 & ".__.00' AND ProjCode <> '" & p7 & "' AND ((DateBegin<='" & d & "' AND DateEnd>='" & d & "') OR StatusID IS NULL OR StatusID='6' OR StatusID='7')"%>
<%mdbor3.Open mdbo3%>
...
<td class="inv" class="inv">
<a href="in.asp?sr=<%=srt & dd%>&e3=<%="Enterprise='" & mdbor4("Enterprise") & "'"%>&no=<%="3"%>&s=<%=co%>&em=<%=pb%>&y=<%=zo%>&so=<%=Request.QueryString("So")%>"><%=mdbor4("Edescr")%></a>
</td>
<td class="inv" class="inv">
...
<a href="in.asp?sr=<%=srt & dd%>&s=<%="StatusID='" & mdbor4("StatusID") & "'"%>&no=<%="3"%>&y=<%=zo%>&em=<%=pb%>&e3=<%=np%>&so=<%=Request.QueryString("So")%>"><%=mdbor4("StatusName")%></a>
</td>
<td class="inv" class="inv">

<%a33="?" & mdbor4("EmployeeID")%>
<%If a33 = "?" Then%>
<a href="in.asp?sr=<%=srt & dd%>&em=<%="EmployeeID IS NULL "%>&no=<%="3"%>&y=<%=zo%>&s=<%=co%>&e3=<%=np%>&so=<%=Request.QueryString("So")%>"><%=mdbor4("EmplFName")%>&nbsp<%=mdbor4("EmplName")%></a>
<%Else%>
<a href="in.asp?sr=<%=srt & dd%>&em=<%="EmployeeID='" & mdbor4("EmployeeID") & "'"%>&no=<%="3"%>&y=<%=zo%>&s=<%=co%>&e3=<%=np%>&so=<%=Request.QueryString("So")%>"><%=mdbor4("EmplFName")%>&nbsp<%=mdbor4("EmplName")%></a>
<%End If%>
...
<td class="inv" class="inv">
<a href="in.asp?sr=<%=srt & dd%>&e3=<%="Enterprise='" & mdbor5("Enterprise") & "'"%>&no=<%="3"%>&s=<%=co%>&em=<%=pb%>&y=<%=zo%>&so=<%=Request.QueryString("So")%>"><%=mdbor5("Edescr")%></a>
</td>
<td class="inv" class="inv">
...
<a href="in.asp?sr=<%=srt & dd%>&s=<%="StatusID='" & mdbor5("StatusID") & "'"%>&no=<%="3"%>&y=<%=zo%>&em=<%=pb%>&e3=<%=np%>&so=<%=Request.QueryString("So")%>"><%=mdbor5("StatusName")%></a>
</td>
<td class="inv" class="inv">

<%a33="?" & mdbor5("EmployeeID")%>
<%If a33 = "?" Then%>
<a href="in.asp?sr=<%=srt & dd%>&em=<%="EmployeeID IS NULL "%>&no=<%="3"%>&y=<%=zo%>&s=<%=co%>&e3=<%=np%>&so=<%=Request.QueryString("So")%>"><%=mdbor5("EmplFName")%>&nbsp<%=mdbor5("EmplName")%></a>
<%Else%>
<a href="in.asp?sr=<%=srt & dd%>&em=<%="EmployeeID='" & mdbor5("EmployeeID") & "'"%>&no=<%="3"%>&y=<%=zo%>&s=<%=co%>&e3=<%=np%>&so=<%=Request.QueryString("So")%>"><%=mdbor5("EmplFName")%>&nbsp<%=mdbor5("EmplName")%></a>
<%End If%>
...
<td class="sin" >
<%If Request.QueryString("so")="all" Then%>
<a href="in.asp?so=group&sr=<%=srt & dd%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>"><font size="2" Color="000000"><Img border="0" src="icons/summ.png"></a>
<%Else%>
<a href="in.asp?so=all&sr=<%=srt & dd%>&no=<%=n%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=np%>"><font size="2" Color="000000"><Img border="0" src="icons/list.png"></a>
<%End If%>
</td>
<td class="sin" >
...
<td class="sin" >
<a href="in.asp?sr=<%=srt & dd%>&no=<%=""%>&y=<%=zo%>&s=<%=co%>&em=<%=pb%>&e3=<%=""%>&so=<%=so%>">K&otildeik</a></td>
<td class="sin" >
<%=sup%></td>
<td class="sin" >
<%=suc%></td>
<td class="sin" >
<a href="in.asp?sr=<%=srt & dd%>&no=<%=""%>&y=<%=zo%>&s=<%=""%>&em=<%=pb%>&e3=<%=np%>&so=<%=so%>">K&otildeik</a></td>
<td class="sin" >
<a href="in.asp?sr=<%=srt & dd%>&no=<%=""%>&y=<%=zo%>&s=<%=co%>&em=<%=""%>&e3=<%=np%>&so=<%=so%>">K&otildeik</a></td>
</tr>
</Form>
</table>
</body>
