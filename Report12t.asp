...
<%mdbor6a.Open mdbo6a%>
<%mdbo7.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) as summi, ISNULL(SUM(ISNULL(CREDIT,0))/1000,0) AS summym FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND (konto BETWEEN '18410' AND '18433') AND RenovBlock=0 AND ((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "' AND SUBSTRING(MES, 2, 2) >= 04)  or (SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "' AND SUBSTRING(MES, 2, 2) < 04)) AND (IDentifier = 'C')"%>
<%mdbor7.Open mdbo7%>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
 ...
 <%Else%>
  <%a0="a1b"%>
  <input type="Text" value="<%=CLNG(CDBL(a6)+CDBL(a6a))%>" size="10" name="<%="a1b"%>" class="boldProjGrup">
<%End If%>
...
<%=CLNG(CDbl(a2)+CDBL(a1)-CDBL(a3)-CDBL(a6)+CDBL(a7))%>
...
<%Else%>
  <%a0="ab"%>
  <input type="Text" value="<%=CLNG(CDBL(a6)+CDBL(a6a))%>" size="10" name="<%="ab"%>" class="boldProjGrup">
<%End If%>
...
<%Else%>
  <%a0="ab" & mdborl1("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6)+CDBL(a6a))%>" size="10" name="<%="ab" & mdborl1("Pid")%>" class="ProjGrup">
<%End If%>
...
<%Else%>
  <%a0="ab" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6)+CDBL(a6a))%>" size="10" name="<%="ab" & mdborl2("Pid")%>" class="ProjGrup">
<%End If%>
...
<%Else%>
  <%a0="ab" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6)+CDBL(a6a))%>" size="10" name="<%="ab" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>" class="Enterp">
<%End If%>
...
<%Else%>
  <%a0="ab" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6)+CDBL(a6a))%>" size="10" name="<%="ab" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>" >
<%End If%>
...
<%a3=mdbor6a("EM")%>
<%End If%>
<%=CLNG(CDBL(CDbl(a2)+CDBL(a1)-CDBL(a3)-CDBL(a6)+CDBL(a7))%>
</td>
<td>
...
<%End If%>
<%a0="a1c"%>
<%=CLNG(CDbl(a6)-CDbl(a3)+CDbl(a1)+CDbl(a2))%>
...
<%mdborl1.Open mdbol1%>
<%mdbo3u.CommandText="SELECT ROUND((SUM(ISNULL(DEBET,0))/1000),0) AS summc, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor3u.Open mdbo3u%>
...
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT ROUND(SUM(ISNULL(CREDIT,0))/1000,0) AS summc, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)<>'999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') And Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Description<>'MAAGAAS' AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT ROUND(SUM(ISNULL(DEBET,0))/1000,0) AS summd, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351' GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor4.Open mdbo4%>
...
<%mdbo3u.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo2.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET+1,0))/1000),0),0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor2.Open mdbo2%>
<%mdbo2u.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C')"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT ISNULL(ROUND(SUM(ISNULL(CREDIT+2,0))/1000,0),0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)<>'999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') And Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Description<>'MAAGAAS' AND (IDentifier = 'C')"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT ISNULL(ROUND(SUM(ISNULL(DEBET,0))/1000,0),0) AS summd FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND RenovBlock=0 AND (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351'"%>
<%mdbor4.Open mdbo4%>
<%mdbo5.CommandText="SELECT  SUM(SummaPlan) AS SP FROM dbo.Delta WHERE yearr='" & ya & "' AND enn<>'00' AND RenovBlock=0"%>
<%mdbor5.Open mdbo5%>
<%mdbo6.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0)-ISNULL(ROUND(SUM(ISNULL(CREDIT,0))/1000,0),0) AS summy FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya-1 & "' AND (konto BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya-1,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04)) OR (LEFT(MES,1)=" & Mid(ya,4,1) & " AND RIGHT(MES,2) <04))  AND (IDentifier = 'C')"%>
<%mdbor6.Open mdbo6%>
<%mdbo6a.CommandText="SELECT  SUM(ISNULL(Ettemaks,0)) AS EM,SUM(ISNULL(Saldo,0)) AS SD FROM dbo.ETTE WHERE yearr='" & ya & "' AND enn<>'00' AND RenovBlock=0"%>
<%mdbor6a.Open mdbo6a%>
<%mdbo7.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0) as summi, ISNULL(ROUND((SUM(ISNULL(CREDIT,0))/1000),0),0) AS summym FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND (konto BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C')"%>
<%mdbor7.Open mdbo7%>
<tr class="bold">
<td></td>
<td></td>
...
<%mdbo3u.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo2.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor2.Open mdbo2%>
<%mdbo2u.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C')"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(CREDIT,0))/1000),0),0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)<>'999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') And Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Description<>'MAAGAAS' AND (IDentifier = 'C')"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT ISNULL(ROUND((SUM(ISNULL(DEBET,0))/1000),0),0) AS summd FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND RenovBlock=0 AND (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351'"%>
<%mdbor4.Open mdbo4%>
<%mdbo5.CommandText="SELECT  SUM(SummaPlan) AS SP FROM dbo.Delta WHERE yearr='" & ya & "' AND enn<>'00' AND RenovBlock=0"%>
