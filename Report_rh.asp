...
<%Else%>
  <%a0="a1c"%>
<input type="Text" value="<%=Request.Form(a0)%>" name="<%="a1c"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%End If%>
</td>
<td>
<%If Request.Form("btn")="Kopeerimiseks" Then%>
...
<%Else%>
  <%a0="a1d"%>
<input type="Text" value="<%=Request.Form(a0)%>" name="<%="a1d"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%End If%>
</td>
<td>
...
<input type="Text" value="<%=sim%>" name="<%="a1y"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%Else%>
<input type="Text" value="<%=Request.Form(a0)%>" name="<%="a1y"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%End If%>
<%End If%>
...
<%Else%>
  <%a0="a1z"%>
<%If Request.Form(a0)="" Then%>
<input type="Text" value="<%=sim%>" name="<%="a1z"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%Else%>
<input type="Text" value="<%=Request.Form(a0)%>" name="<%="a1z"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%End If%>
<%End If%>
...
<%Else%>
  <%a0="a1e"%>
<%If Request.Form(a0)="" Then%>
<input type="Text" value="<%=sim%>" name="<%="a1e"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%Else%>
<input type="Text" value="<%=Request.Form(a0)%>" name="<%="a1e"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
<%End If%>
<%End If%>
...
<%End If%>
  ...
  <%Else%>
    <%a0="a1f" & ja & "_1x"%>
    <%If Request.Form(a0)="" Then%>
      <input type="Text" value="<%=sim%>" name="<%="a1f" & ja & "_1x"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
    <%Else%>
      <input type="Text" value="<%=Request.Form(a0)%>" name="<%="a1f" & ja & "_1x"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
    <%End If%>
  <%End If%>
...
<%Else%>
   <%a0="a" & ja & "_1x"%>
   <%If Request.Form(a0)="" Then%>
      <input type="Text" value="<%=sim%>" name="<%="a" & ja & "_1x"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
   <%Else%>
      <input type="Text" value="<%=Request.Form(a0)%>" name="<%="a" & ja & "_1x"%>" size="10" style="font-family: Verdana; font-weight:700; color: #FFFFFF; background-color: #FFFFFF; border-width:0">
   <%End If%>
<%End If%>
