...
<%End If%>
<img border="0" src="icons/report.ico" Style=float:Left><p align="center"><a href="Main.asp" target="_top" class="headlink"><%=ya%> majandusaasta investeeringute kava 12 kuu l&otilde;ikes</a></p><p>
<%zzz=ya%>
<%zzz=zzz-1%>
<%zzz2=zzz+2%>
<Form Method="POST" Action="Report12.asp?ye=<%=ya%>">
...
<%set mdboup = Server.CreateObject("ADODB.Command")%>
<%set mdborup = Server.CreateObject("ADODB.Recordset")%>
<%mdboup.ActiveConnection = mdbo%>
...
<tr>
 ...
 <th>Ettemaksed ja p&otilde;hivara laos seisuga 31.03.<%=ya+1%></th>
 ...
 <th>L&otilde;petamata ehitus seisuga 31.03.<%=ya+1%></th>
</tr>
<tr class="Repnum">
<%For nuu=1 to 12%>
 <td><%=nuu%></td>
...
<%mdborl1.Open mdbol1%>
<%mdbo2.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor2.Open mdbo2%>
<%mdbo2u.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C')"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT ISNULL(ROUND(SUM(ISNULL(GP.CREDIT,0))/1000,0),0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)<>'999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') And Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04)))  AND (IDentifier = 'C')"%>
<%mdbor3.Open mdbo3%>
<%mdbo3u.CommandText="SELECT ISNULL(ROUND(SUM(ISNULL(GP.DEBET,0))/1000,0),0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo4.CommandText="SELECT ISNULL(ROUND(SUM(ISNULL(DEBET,0))/1000,0),0) AS summd FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351'"%>
<%mdbor4.Open mdbo4%>
<%mdbo5.CommandText="SELECT  SUM(SummaPlan) AS SP FROM dbo.Delta WHERE yearr='" & ya & "' AND enn<>'00' AND RenovBlock=0"%>
<%mdbor5.Open mdbo5%>
<%mdbo6.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0)-ISNULL(SUM(ISNULL(CREDIT,0))/1000,0) AS summy FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya-1 & "' AND (konto BETWEEN '18410' AND '18433') AND RenovBlock=0 AND ((SUBSTRING(MES, 1, 1) = '" & Mid(ya-1,4,1) & "' and SUBSTRING(MES, 2, 2) >= 04) or (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "' and SUBSTRING(MES, 2, 2) <04))   AND (IDentifier = 'C')"%>
<%mdbor6.Open mdbo6%>
...
<td>
IVESTEERINGUD KOKKU v&auml;lja arvatud plokkide renoveerimine
</td>
<td>
<%=mdbor5("SP")%>
</td>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
 ...
 <%Else%>
  <%a0="a1b"%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="a1b"%>" class="boldProjGrup">
<%End If%>
...
<%Else%>
  <%a0="a1a"%>
  <input type="Text" value="<%=CLNG(CDBL(a7))%>" size="10" name="<%="a1a"%>" class="boldProjGrup">
<%End If%>
...
<%=CLNG(CDbl(a2)+CDBL(a1)-CDBL(a6)+CDBL(a7))%>
...
<%Else%>
  <%a0="a1c"%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="a1c"%>" class="boldProjGrup">
<%End If%>
...
<%mdbor6a.Close%>
<%mdbor7.Close%>
<%mdbo3u.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') and  Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo2.CommandText="SELECT ISNULL((SUM(ISNULL(DEBET,0))/1000),0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor2.Open mdbo2%>
<%mdbo2u.CommandText="SELECT ISNULL((SUM(ISNULL(DEBET,0))/1000),0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') and Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C')"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT ISNULL(SUM(ISNULL(CREDIT,0))/1000,0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'MAAGAAS' AND SUBSTRING(PROJECT,4,3)<>'999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700')  And Yearr='" & ya & "'  AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C')"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summd FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351'"%>
<%mdbor4.Open mdbo4%>
...
<%mdbor6a.Open mdbo6a%>
<%mdbo7.CommandText="SELECT ISNULL(ROUND(SUM(ISNULL(GP.DEBET,0))/1000,0),0)-ISNULL(ROUND(SUM(ISNULL(GP.CREDIT,0))/1000,0),0) AS summym FROM dbo.Main m INNER JOIN dbo.glav_project GP ON m.OracleCode = GP.PROJECT WHERE m.Yearr='" & ya & "' AND (konto BETWEEN '18410' AND '18433') AND GP.MES <" & Mid(ya+1,4,1) & "04 AND (m.IDentIfier = 'C')"%>
<%mdbor7.Open mdbo7%>
<tr class="boldProjGrup">
<td></td>
<td></td>
<td>IVESTEERINGUD KOKKU koos plokkide renoveerimisega</td>
<td><%=mdbor5("SP")%></td>
<td>
<%If mdbor2u.EOF=True THEN%>
<%a1=0%>
...
<%Else%>
  <%a0="ab"%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="ab"%>" class="boldProjGrup">
<%End If%>
...
<%Else%>
  <%a0="aa"%>
  <input type="Text" value="<%=CLNG(CDBL(a7))%>" size="10" name="<%="aa"%>" class="boldProjGrup">
<%End If%>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
  ...
  <%Else%>
  <%a0="ac"%>
  <input type="Text" value="<%=CLNG(a3)%>" size="10" name="<%="ac"%>" class="boldProjGrup">
<%End If%>
...
<%mdbor7.Close%>
<%mdbor6a.Close%>
<%mdbo2.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summi, SUBSTRING(ProjCode, 1, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(ProjCode,1,2)='" & MId(mdborl1("PC"),1,2) & "' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2)"%>
<%mdbor2.Open mdbo2%>
<%mdbo3u.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summc, SUBSTRING(ProjCode, 1, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(Project,4,3)='999' and (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700')  and  Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND SUBSTRING(ProjCode,1,2)='" & MId(mdborl1("PC"),1,2) & "' AND (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04) AND Project<>'EJB206' AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2)"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo2u.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summi, SUBSTRING(ProjCode, 1, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' and SUBSTRING(ProjCode,1,2)='" & MId(mdborl1("PC"),1,2) & "' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2)"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT SUM(ISNULL(CREDIT,0))/1000 AS summc, SUBSTRING(ProjCode, 1, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE  description<>'MAAGAAS' AND SUBSTRING(Project,4,3)<>'999' and (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700')  And Yearr='" & ya & "'  AND (konto NOT BETWEEN '18410' AND '18433') AND SUBSTRING(ProjCode,1,2)='" & MId(mdborl1("PC"),1,2) & "'/* AND Project<>'EJB206' */AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2)"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summd, SUBSTRING(ProjCode, 1, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND SUBSTRING(ProjCode,1,2)='" & MId(mdborl1("PC"),1,2) & "' AND (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351' GROUP BY SUBSTRING(ProjCode, 1, 2)"%>
<%mdbor4.Open mdbo4%>
...
<%Else%>
  <%a0="ab" & mdborl1("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="ab" & mdborl1("Pid")%>" class="ProjGrup">
<%End If%>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
  ...
  <%Else%>
<%a0="aa" & mdborl1("Pid")%>
  <input type="Text" value="<%=CLNG(a7)%>" size="10" name="<%="aa" & mdborl1("Pid")%>" class="ProjGrup">
<%End If%>
...
<%Else%>
  <%a0="ac" & mdborl1("Pid")%>
  <input type="Text" value="<%=CLNG(a3)%>" size="10" name="<%="ac" & mdborl1("Pid")%>" class="ProjGrup">
<%End If%>
...
<%mdbor7.Close%>
<%mdbor6a.Close%>
<%mdbo2.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summi, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND  Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2)"%>
<%mdbor2.Open mdbo2%>
<%mdbo3u.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summc, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' and (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700')  and  Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2)"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo3.CommandText="SELECT SUM(ISNULL(CREDIT,0))/1000 AS summc, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE  description<>'MAAGAAS' AND SUBSTRING(PROJECT,4,3)<>'999' and (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700')  And Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND m.OracleCode<>'EJB206' AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2)"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summd, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND  (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351' GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2)"%>
<%mdbor4.Open mdbo4%>
...
<%mdbor5.Open mdbo5%>
<%mdbo2u.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summi, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND  (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700')   and Yearr='" & ya & "' AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C')  AND (konto NOT BETWEEN '18410' AND '18433') GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2)"%>
<%mdbor2u.Open mdbo2u%>
...
<%Else%>
  <%a0="ab" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="ab" & mdborl2("Pid")%>" class="ProjGrup">
<%End If%>
...
<%Else%>
  <%a0="aa" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(a7)%>" size="10" name="<%="aa" & mdborl2("Pid")%>" class="boldProjGrup">
<%End If%>
...
<%Else%>
  <%a0="ac" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(a3)%>" size="10" name="<%="ac" & mdborl2("Pid")%>" class="ProjGrup">
<%End If%>
...
<%mdbo2u.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summi, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2) AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND  (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700')   and Yearr='" & ya & "' AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND Enterprise='" & Mdborl3("Enterprise") & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C')  AND (konto NOT BETWEEN '18410' AND '18433') GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2), Enterprise"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT SUM(ISNULL(CREDIT,0))/1000 AS summc, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2), Enterprise AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE  description<>'MAAGAAS' AND SUBSTRING(Project,4,3)<>'999' and (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') and Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND m.OracleCode<>'EJB206' AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND Enterprise='" & Mdborl3("Enterprise") & "'/* AND Project<>'EJB206' */AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2), Enterprise"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summd, SUBSTRING(ProjCode, 1, 2), SUBSTRING(ProjCode, 4, 2), Enterprise AS be FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND SUBSTRING(ProjCode,1,5)='" & MId(mdborl2("PC"),1,5) & "' AND Enterprise='" & Mdborl3("Enterprise") & "' AND  (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351' GROUP BY SUBSTRING(ProjCode, 1, 2),SUBSTRING(ProjCode, 4, 2), Enterprise"%>
<%mdbor4.Open mdbo4%>
...
<%Else%>
  <%a0="ab" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="ab" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>" class="Enterp">
<%End If%>
...
<%Else%>
  <%a0="aa" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(a7)%>" size="10" name="<%="aa" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>" class="Enterp">
<%End If%>
...
<%Else%>
  <%a0="ac" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>
  <input type="Text" value="<%=CLNG(a3)%>" size="10" name="<%="ac" & mdborl3("Enterprise") & "_" & mdborl2("Pid")%>" class="Enterp">
<%End If%>
...
<%End If%>
<%a0="a1c"%>
<%wa=CDbl(a6)-CDbl(a3)-CDbl(a9)+CDbl(a1)+CDbl(a2)%>
<%if wa=-1 or wa=1 then%>
0
<%Else%>
<%=CLNG(CDbl(a6)-CDbl(a3)-CDbl(a9)+CDbl(a1)+CDbl(a2))%>
<%End if%>
...
<%mdbor2u.Open mdbo2u%>
<%ELSE%>
<%mdbo2u.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summi FROM glav_project WHERE description<>'maagaas' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND Project='" & mdbor("OracleCode") & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (konto NOT BETWEEN '18410' AND '18433') AND Project='EJB206'  "%>
<%mdbor2u.Open mdbo2u%>
<%END iF%>

<%IF LEN(mdbor("PC"))>9 AND RIGHT(mdbor("PC"),2)="00" then%>
<%mdbo3.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summd FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND SUBSTRING(ProjCode,1,8)='" & MId(mdbor("PC"),1,8) & "' and right(Projcode,2)<>'00' AND Enterprise='" & Mdbor("Enterprise") & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351'"%>
<%mdbor3.Open mdbo3%>
<%ELSE%>
<%mdbo3.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summd FROM glav_project WHERE Project='" & mdbor("OracleCode") & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND KONTO='43350' AND SUBKONTO='4351' "%>
<%mdbor3.Open mdbo3%>
<%END iF%>

<%IF LEN(mdbor("PC"))>9 AND RIGHT(mdbor("PC"),2)="00" then%>
<%mdbo4.CommandText="SELECT ISNULL(SUM(ISNULL(CREDIT,0))/1000,0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE  description<>'MAAGAAS' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND SUBSTRING(ProjCode,1,8)='" & MId(mdbor("PC"),1,8) & "' AND Enterprise='" & Mdbor("Enterprise") & "' and right(Projcode,2)<>'00' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (IDentifier = 'C')"%>
<%mdbor4.Open mdbo4%>
<%ELSE%>
<%mdbo4.CommandText="SELECT ISNULL(SUM(ISNULL(CREDIT,0))/1000,0) AS summc FROM glav_project WHERE  description<>'MAAGAAS' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Project='" & mdbor("OracleCode") & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (konto NOT BETWEEN '18410' AND '18433')"%>
<%mdbor4.Open mdbo4%>
<%END iF%>

<%IF LEN(mdbor("PC"))>9 AND RIGHT(mdbor("PC"),2)="00" then%>
<%mdbo5.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND (KONTO<>'43350' AND SUBKONTO<>'4351') and Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND SUBSTRING(ProjCode,1,8)='" & MId(mdbor("PC"),1,8) & "' AND Enterprise='" & Mdbor("Enterprise") & "' and right(Projcode,2)<>'00' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor5.Open mdbo5%>
<%ELSE%>
<%mdbo5.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summi FROM glav_project WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND Project='" & mdbor("OracleCode") & "' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND (konto NOT BETWEEN '18410' AND '18433') AND Project<>'EJB206'"%>
<%mdbor5.Open mdbo5%>
<%END iF%>
...
<%mdbor6.Open mdbo6%>
<%ELSE%>
<%if mdbor("OracleCode")="EJB597" then%>
...
<%ELSE%>
<%if mdbor("OracleCode")="EJB597" then%>
<%'="SELECT  ISNULL(Ettemaks,0) AS EM,ISNULL(Saldo,0) AS SD FROM dbo.ETTE WHERE ROWID='" & mdbor("ROWID") & "'"%>
<%End if%>
...
<td><%=mdbor("ProjName")%></td>
<td><%=mdbor2("SummaPlan")%></td>
<td>
<%If mdbor2u.EOF=True THEN%>
<%a1=0%>
<%ELSe%>
...
<%Else%>
  <%a0="ab" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="ab" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>" >
<%End If%>
...
<%Else%>
  <%a0="aa" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>
  <input type="Text" value="<%=CLNG(a7)%>" size="10" name="<%="aa" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>" >
<%End If%>
<%acca=CLNG(a7)%>
</td>
<td>
...
<%Else%>
  <%a0="ac" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>
  <input type="Text" value="<%=CLNG(a3)%>" size="10" name="<%="ac" & mdborl3("Enterprise") & "_" & mdbor("Pid")%>" >
<%End If%>
...
<%End If%>
<%a0="a1c"%>
<%abba=CLNG(CDbl(a6)-CDbl(a3)+CDbl(a1)+CDbl(a2))%>
<%=abba%>
<%If CINT(ya)>=2005 AND RIGHT(mdbor("PC"),2)<>"00" then%>
<%mdboup.CommandText="Delete helper Where Pid=" & mdbor("Pid") & " and yearr='" & CINT(ya)+1 & "'"%>
<%mdborup.Open mdboup%>
<%mdboup.CommandText="Insert into helper (Pid,Ettemaks,Saldo,Yearr) Values (" & mdbor("Pid") & "," & acca & "," & abba & ",'" & CINT(ya)+1 & "')"%>
<%mdborup.Open mdboup%>
<%End If%>
<%abba=0%>
<%acca=0%>
...
<%mdborl1.Open mdbol1%>
<%mdbo3u.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summc, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo2.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summi, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506'))) AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor2.Open mdbo2%>
<%mdbo2u.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summi, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT SUM(ISNULL(CREDIT,0))/1000 AS summc, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)<>'999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') And Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND Project<>'EJB206' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Description<>'MAAGAAS' AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT SUM(ISNULL(DEBET,0))/1000 AS summd, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351' GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor4.Open mdbo4%>
...
<%mdbor5.Open mdbo5%>
<%mdbo6.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0)-ISNULL(SUM(ISNULL(CREDIT,0))/1000,0) AS summy, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya-1 & "' AND (konto BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya-1,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04)) OR (LEFT(MES,1)=" & Mid(ya,4,1) & " AND RIGHT(MES,2) <04))  AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor6.Open mdbo6%>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
 ...
 <%Else%>
  <%a0="a8b" & mdborl1("Enterprise")%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="a8b" & mdborl1("Enterprise")%>" class="boldEnterp">
<%End If%>
</td>
<td>
<%If Request.Form("btn")="Kopeerimiseks" Then%>
...
<%Else%>
  <%a0="a8a" & mdborl1("Enterprise")%>
  <input type="Text" value="<%=CLNG(a7)%>" size="10" name="<%="a8a" & mdborl1("Enterprise")%>" class="boldEnterp">
<%End If%>
...
<%Else%>
  <%a0="a8c" & mdborl1("Enterprise")%>
  <input type="Text" value="<%=CLNG(CDBL(a33))%>" size="10" name="<%="a8c" & mdborl1("Enterprise")%>" class="boldEnterp">
<%End If%>
</td>
<td>
<%=CLNG(CDbl(a33)-CDbl(a3)-CDbl(a9)+CDbl(a1)+CDbl(a2))%>
</td>
</tr>
<%If mdbor5.EOF <> true Then%>
<%mdbor5.Movenext%>
...
<%mdbo3u.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)='999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor3u.Open mdbo3u%>
<%mdbo2.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET+1,0))/1000,0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND ((Konto<>'18164' AND Konto<>'18151') OR ((Konto='18164' OR Konto='18151') AND SUBSTRING(PROJECT,4,3)='999') OR (Konto='18164' AND (PROJECT='EJE573' OR PROJECT='EJE516' OR PROJECT='EJB515' OR PROJECT='EJB583') AND (MES='504' OR MES='505' OR MES='506' OR MES='507'))) AND Yearr='" & ya & "' AND (konto NOT BETWEEN '18410' AND '18433') AND (KONTO<>'43350' AND SUBKONTO<>'4351') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project<>'EJB206' AND (IDentifier = 'C')"%>
<%mdbor2.Open mdbo2%>
<%mdbo2u.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summi FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE description<>'maagaas' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') AND Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Project='EJB206' AND (IDentifier = 'C')"%>
<%mdbor2u.Open mdbo2u%>
<%mdbo3.CommandText="SELECT ISNULL(SUM(ISNULL(CREDIT+2,0))/1000,0) AS summc FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE SUBSTRING(PROJECT,4,3)<>'999' AND (ISNULL(DOCS_REGNR,0)=0 OR DOCS_REGNR<>'437700') And Yearr='" & ya & "' AND RenovBlock=0 AND (konto NOT BETWEEN '18410' AND '18433') AND Project<>'EJB206' AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04))  or ((SUBSTRING(MES, 1, 1) = '" & Mid(ya+1,4,1) & "') AND (SUBSTRING(MES, 2, 2) < 04))) AND Description<>'MAAGAAS' AND (IDentifier = 'C')"%>
<%mdbor3.Open mdbo3%>
<%mdbo4.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0) AS summd FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya & "' AND RenovBlock=0 AND (SUBSTRING(MES, 1, 1) = '" & Mid(ya,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04) AND (IDentifier = 'C') AND KONTO='43350' AND SUBKONTO='4351'"%>
<%mdbor4.Open mdbo4%>
<%mdbo5.CommandText="SELECT  SUM(SummaPlan) AS SP FROM dbo.Delta WHERE yearr='" & ya & "' AND enn<>'00' AND RenovBlock=0"%>
<%mdbor5.Open mdbo5%>
<%mdbo6.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0)-ISNULL(SUM(ISNULL(CREDIT,0))/1000,0) AS summy FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya-1 & "' AND (konto BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya-1,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04)) OR (LEFT(MES,1)=" & Mid(ya,4,1) & " AND RIGHT(MES,2) <04))  AND (IDentifier = 'C')"%>
...
<%Else%>
  <%a0="a4b"%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="a4b"%>" class="bold">
<%End If%>
</td>
<td>
<%If mdbor7.EOF=True THEN%>
...
<%Else%>
  <%a0="a4a"%>
  <input type="Text" value="<%=CLNG(CDBL(a7))%>" size="10" name="<%="a4a"%>" class="bold">
<%End If%>
</td>
<td>
<%If mdbor2u.EOF=True THEN%>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
  ...
  <%Else%>
  <%a0="a4c"%>
  <input type="Text" value="<%=CLNG(a3)%>" size="10" name="<%="a4c"%>" class="bold">
<%End If%>
</td>
<td>
<%If mdbor6A.EOF=true then%>
...
<%mdbor5.Open mdbo5%>
<%mdbo6.CommandText="SELECT ISNULL(SUM(ISNULL(DEBET,0))/1000,0)-ISNULL(ROUND((SUM(ISNULL(CREDIT,0))/1000),0),0) AS summy, Enterprise FROM dbo.glav_project gp INNER JOIN Main m ON GP.Project = m.ORaclecode WHERE Yearr='" & ya-1 & "' AND (konto BETWEEN '18410' AND '18433') AND RenovBlock=0 AND (((SUBSTRING(MES, 1, 1) = '" & Mid(ya-1,4,1) & "') AND (SUBSTRING(MES, 2, 2) >= 04)) OR (LEFT(MES,1)=" & Mid(ya,4,1) & " AND RIGHT(MES,2) <04))  AND (IDentifier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
<%mdbor6.Open mdbo6%>
...
<%mdbor6a.Open mdbo6a%>
    <%mdbo7.CommandText="SELECT ISNULL(ROUND(SUM(ISNULL(GP.DEBET,0))/1000,0),0)-ISNULL(ROUND(SUM(ISNULL(GP.CREDIT,0))/1000,0),0) AS summym, Enterprise FROM dbo.Main m INNER JOIN dbo.glav_project GP ON m.OracleCode = GP.PROJECT WHERE m.Yearr='" & ya & "' AND (konto BETWEEN '18410' AND '18433') AND m.RenovBlock=0 AND GP.MES <" & Mid(ya+1,4,1) & "04 AND (m.IDentIfier = 'C') GROUP BY Enterprise ORDER BY Enterprise"%>
    <%mdbor7.Open mdbo7%>
<%Do until mdborl1.EOF%>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
 ...
 <%Else%>
  <%a0="a5b" & mdborl1("Enterprise")%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="a5b" & mdborl1("Enterprise")%>" class="boldEnterp">
<%End If%>
</td>
<td>
<%If Request.Form("btn")="Kopeerimiseks" Then%>
...
<%Else%>
  <%a0="a5a" & mdborl1("Enterprise")%>
  <input type="Text" value="<%=CLNG(a7)%>" size="10" name="<%="a5a" & mdborl1("Enterprise")%>" class="boldEnterp">
<%End If%>
</td>
<td>
<%=CLNG(CDbl(a2)+CDBL(a1)-CDBL(a6)+CDBL(a7))%>
...
<%Else%>
  <%a0="a5c" & mdborl1("Enterprise")%>
  <input type="Text" value="<%=CLNG(a33)%>" size="10" name="<%="a5c" & mdborl1("Enterprise")%>" class="boldEnterp">
<%End If%>
</td>
<td>
<%a0="a5c"%>
...
<%If Request.Form("btn")="Kopeerimiseks" Then%>
 ...
 <%Else%>
  <%a0="a7b"%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="a7b"%>" class="bold">
<%End If%>
</td>
<td>
<%If mdbor7.EOF=True THEN%>
...
<%Else%>
  <%a0="a7a"%>
  <input type="Text" value="<%=CLNG(CDBL(a7))%>" size="10" name="<%="a7a"%>" class="bold">
<%End If%>
</td>
<td>
<%If mdbor2u.EOF=True THEN%>
...
<%Else%>
  <%a0="a7c"%>
  <input type="Text" value="<%=CLNG(CDBL(a6))%>" size="10" name="<%="a7c"%>" class="bold">
<%End If%>
</td>
<td>
<%If mdbor6A.EOF=true then%>
